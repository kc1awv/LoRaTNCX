...
void KissProtocol::reset() { state = KISS_STATE_IDLE; rxBufferPos = 0; }
...
String KissProtocol::commandToString(uint8_t command) {
    switch (command) {
        case KISS_CMD_DATA: return "DATA";
        case KISS_CMD_TXDELAY: return "TXDELAY";
        case KISS_CMD_P: return "PERSISTENCE";
        case KISS_CMD_SLOTTIME: return "SLOTTIME";
        case KISS_CMD_TXTAIL: return "TXTAIL";
        case KISS_CMD_FULLDUPLEX: return "FULLDUPLEX";
        case KISS_CMD_SETHARDWARE: return "SETHARDWARE";
        case KISS_CMD_RETURN: return "RETURN";
